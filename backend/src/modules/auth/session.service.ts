...
/**
 * Server-side sessions. The raw token exists only in the cookie; the
...
export class SessionService {
  ...
  /** Rotates on login: a fresh token every time, never reusing the old. */
  ...
  /** Double-submit CSRF: cookie value must match the request header. */
